...
describe('Check Business site Home Page All Component and Button Functionality', () => {
  ...
  it('Explore Cloud section', async () => {
  ...
  it('Forget worries About coding', async () => {
  ...
  it('Leave Your Footprint Everywhere', async () => {
 ...
 ----------------------------------------------------------------- */
  ...
  it('Social icon hover effect check and click', async () => {
